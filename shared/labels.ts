/**
 * Labels e cores das constants de leads.
 * Tipos repetidos aqui (não importa do schema) pra evitar dependência cruzada
 * entre frontend e Drizzle. Devem manter sync com db/schema.ts.
 */
